...
class Api
{
	...
	public function last_post_id($JO_Number)
	{
		...
		$query = "	select index_load as index_load from API_Logs_Detail where Method = 'POST' and JO_Number = '" . $JO_Number . "' and `type`='dev-bsp' and index_load > 2327
					union
					(select index_load as index_load from API_Post_Gagal where JO_Number = '" . $JO_Number . "' and `type`='dev-bsp' and index_load > 2327)
	...
	public function loadJoNumber($JO_Number)
	{
		...
		$query = "select a.Ticket_Id, a.index_load , Createdate as RecordDate, a.Qty_Jobmix as Load_Size, d.Jobmix_Code as Load_Item_Code , a.BP_ID as BP_ID, a.CreateBy, b.api, b.api_time_correction, a.Driver as Driver_Code, a.Truck as Truck_Code,b.bp_name, c.region_name
				from `TICKET` a
				...
				where a.Jo_Number = '" . $JO_Number . "' " . $last_post_id . $apiupdate . " and b.api='dev-bsp' order by index_load asc limit 5";

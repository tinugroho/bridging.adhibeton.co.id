    ...
    <div class="pcoded-wrapper">
        <nav class="pcoded-navbar">
            ...
            <div class="pcoded-inner-navbar main-menu">
                ...
                <!-- menu dinamis -->
                <?php
                $menu = $this->session->userdata('menu_category');
                $list_menu = $this->session->userdata('menu_list');
                $list_submenu = $this->session->userdata('submenu');
                ?>
                                    ...
                                    <?php } else { ?>
                                        <li class="pcoded-hasmenu">
                                            ...
                                            <ul class="pcoded-submenu">
                                                <!-- lopping submenu -->
                                                <?php foreach ($list_submenu as $sm) {
                                                    if ($sm['id_menu_list'] == $ml['id']) { ?>
